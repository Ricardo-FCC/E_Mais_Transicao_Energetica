...
# 1. Marketplace Panel
marketplace_code = """\\"use client\\"
import { ShoppingCart, Leaf, TrendingUp, ArrowUpRight, DollarSign } from \\"lucide-react\\"
...
# 2. Matching Panel
matching_code = """\\"use client\\"
import { UserCheck, MapPin, Building2, Handshake, Zap, ChevronRight } from \\"lucide-react\\"
          ...
          <Card key={m.id} className=\\"bg-[#111]/50 border-white/5 hover:border-cyan-500/30 transition-all duration-300 group\\">
            <CardContent className=\\"p-4\\">
              <div className=\\"flex items-center justify-between gap-4\\">
                ...
                <Button size=\\"sm\\" variant=\\"ghost\\" className=\\"group-hover:bg-cyan-500 group-hover:text-black transition-all rounded-full h-8 w-8 p-0\\">
...
sidebar = sidebar.replace(
    'import { LayoutDashboard, Zap, Map as MapIcon, BarChart3, Settings } from \\"lucide-react\\"',
    'import { LayoutDashboard, Zap, Map as MapIcon, BarChart3, Settings, ShoppingCart, Handshake } from \\"lucide-react\\"'
)
...
page = page.replace(
    ...
    '{activeTab === \\"map\\" ? \\"Inteligência Territorial (IPN)\\" : activeTab === \\"sim\\" ? \\"Simulador Prospectivo (Nexus Sim)\\" : activeTab === \\"market\\" ? \\"Nexus Market (Créditos & Ativos)\\" : \\"Nexus Match (Conexões Estratégicas)\\"}'
)
...
print(\\"Marketplace and Matching modules added successfully.\\")
